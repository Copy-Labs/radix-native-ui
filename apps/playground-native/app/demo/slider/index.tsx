...
export default function SliderDemo() {
  ...
  return (
    <ThemeProvider themeOptions={{ grayColor: 'slate', accentColor: 'indigo' }}>
      <PageContainer>
              ...
              <Flex direction={'column'} gap={32} padding={16}>
                <Card>
                  <Text size={3} color="gray">
                    Note: The slider component is currently in beta. Please report any issues you
                    encounter.
                  </Text>
                </Card>
                ...
                <Flex direction={'column'} gap={16} marginBottom={16}>
                  ...
                  <Card size={1}>
                    ...
                    <Slider size="1" defaultValue={30} showValueLabel />
                  </Card>
                  ...
                  <Card size={1}>
                    ...
                    <Slider size="2" defaultValue={50} showValueLabel />
                  </Card>
                  ...
                  <Card size={1}>
                    ...
                    <Slider size="3" defaultValue={70} showValueLabel />
                  </Card>
                  ...
                  <Card size={1}>
                    ...
                    <Slider size="4" defaultValue={85} showValueLabel />
                  </Card>
                </Flex>
                ...
                <Flex direction={'column'} gap={16} marginBottom={16}>
                  ...
                  <Card size={1}>
                    ...
                    <Slider variant="solid" defaultValue={40} showValueLabel />
                  </Card>
                  ...
                  <Card size={1}>
                    ...
                    <Slider variant="soft" defaultValue={60} showValueLabel />
                  </Card>
                  ...
                  <Card size={1}>
                    ...
                    <Slider variant="surface" defaultValue={40} showValueLabel />
                  </Card>
                  ...
                  <Card size={1}>
                    ...
                    <Slider variant="outline" defaultValue={60} showValueLabel />
                  </Card>
                </Flex>
                ...
                <Flex direction={'column'} gap={8} marginBottom={16}>
                  ...
                  <Card size={1}>
                    ...
                    <Slider defaultValue={50} showValueLabel />
                  </Card>
                  ...
                  <Card size={1}>
                    ...
                    <Slider highContrast defaultValue={50} showValueLabel />
                  </Card>
                ...
                <Flex direction={'column'} gap={8} marginBottom={16}>
                  ...
                  <Card size={1}>
                    ...
                    <Slider color="blue" defaultValue={40} showValueLabel />
                  </Card>
                  ...
                  <Card size={1}>
                    ...
                    <Slider color="green" defaultValue={60} showValueLabel />
                  </Card>
                  ...
                  <Card size={1}>
                    ...
                    <Slider color="red" defaultValue={30} showValueLabel />
                  </Card>
                  ...
                  <Card size={1}>
                    ...
                    <Slider color="purple" defaultValue={70} showValueLabel />
                  </Card>
                </Flex>
                ...
                <Flex direction={'column'} gap={8} marginBottom={16}>
                  ...
                  <Slider disabled defaultValue={50} showValueLabel label="Disabled Slider" />
                </Flex>
                ...
                <Flex direction={'column'} gap={8} marginBottom={16}>
                  ...
                  <Slider min={-50} max={50} defaultValue={0} showValueLabel label="Temperature" />
                </Flex>
                ...
                <Flex direction={'column'} gap={8} marginBottom={16}>
                  ...
                  <Card size={1}>
                    ...
                    <Slider radius="full" defaultValue={50} showValueLabel />
                  </Card>
                  ...
                  <Card size={1}>
                    ...
                    <Slider radius="large" defaultValue={50} showValueLabel />
                  </Card>
                  ...
                  <Card size={1}>
                    ...
                    <Slider radius="medium" defaultValue={50} showValueLabel />
                  </Card>
                  ...
                  <Card size={1}>
                    ...
                    <Slider radius="small" defaultValue={50} showValueLabel />
                  </Card>
                  ...
                  <Card size={1}>
                    ...
                    <Slider radius="none" defaultValue={50} showValueLabel />
                  </Card>
                </Flex>
